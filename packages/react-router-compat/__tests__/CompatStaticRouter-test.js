...
import { Route, Prompt, Redirect, StaticRouter } from "react-router-compat";
...
describe("A <StaticRouter>", () => {
  ...
  xit("reports redirects on the context object", () => {
    const context = {};
  ...
  xit("reports push redirects on the context object", () => {
    const context = {};
  ...
  xit("knows how to serialize location objects", () => {
    const context = {};
  ...
  describe("with a basename", () => {
    ...
    xit("adds the basename to redirect URLs", () => {
      const context = {};
    ...
    xit("adds the basename to push redirect URLs", () => {
      const context = {};
